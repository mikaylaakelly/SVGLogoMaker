...
describe('Shapes', () => {
  describe('Circle', () => {
    it('should render a red circle', () => {
      ...
      expect(svgElement).toContain('fill="red"');
    });
  });
  ...
  describe('Square', () => {
    it('should render a blue square', () => {
      ...
      expect(svgElement).toContain('Square');
      expect(svgElement).toContain('fill="blue"');
    });
  });
  ...
  describe('Triangle', () => {
    it('should render a green triangle', () => {
      ...
      expect(svgElement).toContain('Triangle');
      expect(svgElement).toContain('fill="green"');
    });
  });
});